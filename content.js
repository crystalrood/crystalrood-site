...
(function attachSiteContent(global) {
  ...
  const recipes = [
    ...
    },
    {
      ...
      eyebrow: "Cookies",
      summary: "Gluten-free chocolate chip cookies with maple, almond, dark chocolate, and flaky salt.",
      description:
        "Gluten-free cookies made with Caputo Fioreglut, maple syrup, almond butter, and dark chocolate.",
      category: "Cookies",
      cuisine: "",
      timeLabel: "2 hr chill · 10–12 min bake",
      prepMinutes: null,
      cookMinutes: null,
      totalMinutes: null,
      yield: "",
      ...
      directions: [
        {
          heading: "Mix the dry ingredients",
          text: "Whisk together the Fioreglut, baking soda, and salt.",
        },
        {
          heading: "Mix the wet ingredients",
          text: "Beat the room-temperature butter, almond butter, brown sugar, granulated sugar, and maple syrup until smooth. Beat in the egg yolks, vanilla, and almond extract.",
        },
        {
          heading: "Finish the dough",
          text: "Add the dry ingredients and mix just until combined, then fold in the dark chocolate.",
        },
        {
          heading: "Portion and chill",
          text: "Portion the dough into 40–45 g rounded balls. Refrigerate for 2 hours; do not freeze.",
        },
        {
          heading: "Preheat",
        ...
        {
          heading: "Bake",
          text: "Bake directly from the refrigerator. Start checking at 10 minutes; the cookies will likely take 10–12 minutes. Remove them while the centers still look soft, sprinkle with flaky salt, and let them rest on the tray for 10 minutes.",
        },
      ],
      notes: [],
      source: { label: "", url: "" },
